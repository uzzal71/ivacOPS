...
<div class="x_panel">
  ...
  <div class="x_content">
    <br />
    <form class="form-horizontal form-label-left" autocomplete="off" action="<?php echo site_url('income_type_controller/save');?>" method="POST">
     ...
     <div class="col-md-9 col-sm-9 col-xs-12">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input type="text" class="form-control" name="income_type" placeholder="Income Type" required>
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input type="text" class="form-control" name="income_amount" placeholder="Income Amount" required>
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
          ...
          <button type="submit" class="btn btn-success">Add Income Type</button>
        </div>
      </div>
