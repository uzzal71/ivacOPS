...
<table style="width: 600px; border: 1px solid black; border-collapse: collapse;">
	<thead>
	 <tr>
		...
		<th style="border: 1px solid black; border-collapse: collapse;padding: 2px;text-align:center;">Income Amount(TK)</th>
	</tr>
	</thead>
	<tbody>
...
<table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
	<thead>
	 <tr>
		<th style="border: 1px solid black; border-collapse: collapse;padding: 2px;text-align:right;">Total Income</th>
